...
description: Design system extracted from Linear (https://linear.app/). Use when building UI that should match this brand's visual identity.
triggers:
  - "Linear"
  - "linear-app"
  - "design like Linear"
...
extractedAt: 2026-09-03T23:41:16.759Z
